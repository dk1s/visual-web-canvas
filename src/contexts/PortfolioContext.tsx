...
const defaultData: PortfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      liveUrl: "https://app.locapay.co.ke/",
      githubUrl: "#",
      featured: true,
      type: "Professional",
    ...
    {
      title: "Cricket Gyan",
      description: "Comprehensive cricket knowledge and analytics platform delivering real-time match updates, detailed statistics, and interactive cricket insights. Built with React and Redux for robust state management, WebSocket for live data streaming, and RTK Query for efficient data fetching.",
      icon: "🏏",
      tags: ["React", "Redux", "Tailwind CSS", "WebSocket", "TypeScript"],
      liveUrl: "https://cricketgyan.com/",
      githubUrl: "#",
      featured: true,
      type: "Professional",
    ...
    {
      title: "CricketGyan",
      description: "Full-featured cricket platform where users can watch live match scores, follow series, check rankings, view schedules, read statistics, browse news, photos, videos, and explore teams. Features all major sections: Live Scores, Series, Rankings, Schedule, Statistics, News, Photos, Videos, and Teams — all powered by real-time Socket.IO updates.",
      icon: "🏏",
      tags: ["React", "Tailwind CSS", "TypeScript", "Socket.IO", "Redux", "RTK Query"],
      liveUrl: "https://cricketgyan.com/",
      githubUrl: "#",
      featured: true,
      type: "Professional",
      highlights: ["Live Scores", "Socket.IO", "RTK Query", "Series & Rankings"],
    },
    {
