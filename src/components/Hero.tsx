    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-background via-background to-muted/30">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            <motion.span 
              className="px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-medium border border-primary/20 inline-block"
              whileHover={{ scale: 1.05 }}
              transition={springTransition}
            >
              💼 Software Developer at 86 Agency • Since March 2025
            </motion.span>
          </motion.div>
          ...
          >
            <motion.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.98 }} transition={springTransition}>
          ...
          >
            <motion.a
              ...
              className="p-3 rounded-full bg-muted/50 hover:bg-muted text-muted-foreground hover:text-foreground transition-colors duration-300"
